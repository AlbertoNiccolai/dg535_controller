import pyvisa
import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QPushButton, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QInputDialog, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.trigger_rate = 10
        self.trigger_mode = 2
        self.trigger_slope = 1
        self.delay_T0 = 0
        self.delay_A = 0
        self.delay_B = 0
        self.delay_AB = 0
        ...
        # Set up the UI
        self.setup_ui()
        self.refresh_settings()  # Ensure settings are refreshed after UI is set up
...
class SecondaryWindow(QWidget):
    ...
    def write_on_dg535_tm(self):
        """Method to handle trigger mode entry and update"""
        pass

    def write_on_dg535_tr(self):
        """Method to handle trigger rate entry and update"""
        pass

    def write_on_dg535_ts(self):
        """Method to handle trigger slope entry and update"""
        pass

    def write_on_dg535_t0(self):
        """Method to handle T0 delay entry and update"""
        pass

    def write_on_dg535_a(self):
        """Method to handle A delay entry and update"""
        pass

    def write_on_dg535_b(self):
        """Method to handle B delay entry and update"""
        pass

    def write_on_dg535_ab(self):
        """Method to handle AB delay entry and update"""
        pass

    def write_on_dg535_c(self):
        """Method to handle C delay entry and update"""
        pass

    def write_on_dg535_d(self):
        """Method to handle D delay entry and update"""
        pass

    def write_on_dg535_cd(self):
        """Method to handle CD delay entry and update"""
        pass
